<div class="row">
  <div class="col-md-12">
    <div class="box box-info">
      <div class="box-header with-border">
        <h3 class="box-title">Employee View More</h3>
        <div class="box-body">
          <div class="row clearfix">
           <div class="col-md-6">
             <label for="employeeCode" class="control-label">  <span class="text-danger"></span>Employee Code</label>
             <div class="form-group">
              <input disabled type="text" name="employeeCode" value="<?php echo ($this->input->post('employeeCode') ? $this->input->post('employeeCode') : $employee['employeeCode']); ?>" class="form-control" id="employeeCode" />
          ...
          <div class="col-md-6">
           ...
           <div class="form-group">
            <input disabled type="text" name="employeeName" value="<?php echo ($this->input->post('employeeName') ? $this->input->post('employeeName') : $employee['employeeName']); ?>" class="form-control" id="employeeName" />
        ...
        <div class="col-md-6">
         ...
         <div class="form-group">
          <input disabled type="text" name="employeeDepartment" value="<?php echo ($this->input->post('employeeDepartment') ? $this->input->post('employeeDepartment') : $employee['employeeDepartment']); ?>" class="form-control" id="employeeDepartment" />
      ...
      <div class="col-md-6">
       ...
       <div class="form-group">
        <input disabled type="number" name="employeeAge" value="<?php echo ($this->input->post('employeeAge') ? $this->input->post('employeeAge') : $employee['employeeAge']); ?>" class="form-control" id="employeeAge" />
    ...
    <div class="col-md-6">
     ...
     <div class="form-group">
      <input disabled type="number" name="experienceInOrganization" value="<?php echo ($this->input->post('experienceInOrganization') ? $this->input->post('experienceInOrganization') : $employee['experienceInOrganization']); ?>" class="form-control" id="experienceInOrganization" />
  ...
  <div class="col-md-6">
    ...
    <div class="form-group">
      <select disabled name="employeeStatus" class="form-control">
        <?php  
